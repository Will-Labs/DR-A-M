			...
			<ul class="grid grid-cols-1 medium-grid-cols-2 grid-gap">
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="../assets/img/menus/picrolex.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="../assets/img/menus/pickidney.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="../assets/img/menus/picdoc.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="../assets/img/menus/picchange.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
								<h6 class="item-title"><a href="/item-details/">Brown Hand Watch </a></h6>
