			...
			<form on:submit={login}>
				...
				<button type="submit" class="submit_button">
				 <button type="submit" class="submit_button" 
					...
					<img src="/assets/img/svg/logout.svg" fill="#fff" alt=""> 
