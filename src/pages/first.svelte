	...
	<div class="page-content">
		<div class="container welcome-inner">
			...
			<div class="clearfix pb-30">
				...
				<a class="button-large button button-social rounded-xl button-fill facebook" on:click={facebook_login}><img src="/assets/img/social/facebook.png" alt=""> <span>Login with facebook</span></a>
